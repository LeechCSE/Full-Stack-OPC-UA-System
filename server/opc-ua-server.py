...
async def main():
    ...
    # setup our own namespace, not really necessary but should as 
    idx = 100
    ...
    _logger.info(f"vPLC1 NodeId: {obj_vplc.nodeid}")
    _logger.info(f"Temperature NodeId: {var_temperature.nodeid}")
    _logger.info(f"Pressure NodeId: {var_pressure.nodeid}")
    _logger.info(f"Pumpsetting NodeId: {var_pumpsetting.nodeid}")
